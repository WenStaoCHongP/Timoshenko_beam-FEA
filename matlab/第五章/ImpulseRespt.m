function [eta,y,omega1,sdof2]=ImpulseRespt(kk,mm,fd,u,t,C,q0,dq0,a,b)
%--------------------------------------------------------------------------
%  Purpose:
%    The function subroutine ImpulseRespt.m calculates impulse response of a damping or
...
%  Synopsis:
%    [eta,y,omega1,sdof2]=ImpulseRespt(kk,mm,fd,u,t,C,q0,dq0,a,b)
